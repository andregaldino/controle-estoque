...
Route::get('/',['as'=>'index', 'uses' => 'AuthController@getSignin']);
Route::post('singin',['as'=>'singin', 'uses' => 'AuthController@postSignin']);

//Route::get('singup',['as'=>'singup', 'uses' => 'AuthController@getSignup']);
//Route::post('singup',['as'=>'singup', 'uses' => 'AuthController@postSignup']);
